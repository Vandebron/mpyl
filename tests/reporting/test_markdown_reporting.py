...
from tests.reporting import create_test_result, create_test_result_with_plan, append_results, test_resource_path, \
    tmp_test_resource_path
...
class TestMarkdownReporting:
    def test_should_print_results_as_string(self):
        ...
        assert_roundtrip(test_resource_path / "markdown_run.md", simple_report)
    ...
    def test_should_print_exception(self):
        ...
        simple_report = run_result_to_markdown(run_result)
        assert_roundtrip(test_resource_path / "markdown_run_with_exception.md", simple_report)

    def test_should_print_results_with_plan_as_string(self):
        run_result = create_test_result_with_plan()
        append_results(run_result)
        simple_report = run_result_to_markdown(run_result)
        assert_roundtrip(test_resource_path / "markdown_run_with_plan.md", simple_report)
    ...
    def test_should_convert_test_summary_to_markdown(self):
        ...
        assert_roundtrip(test_resource_path / "test_run_summary.md", test_report)
    ...
    def test_should_combine_duplicate_urls(self):
        ...
        run_result.append(StepResult(stage=Stage.TEST, project=test_data.get_project(),
                                     ...
                                     timestamp=datetime.fromisoformat('2019-01-04T16:41:24+02:00'))),
        simple_report = run_result_to_markdown(run_result)
        assert_roundtrip(test_resource_path / "markdown_run_multiple_urls.md", simple_report)
