...
def main(log: Logger, args: argparse.Namespace):
    if args.local:
        ...
        from src.mpyl.cli.build.mpyl import run_mpyl, MpylRunParameters, MpylRunConfig, MpylCliParameters
    ...
    params = MpylRunParameters(
        run_config=MpylRunConfig(config=config, run_properties=properties),
