pipeline {
    ...
    stages {
        stage('Initialize Parameters') {
            ...
            expression { return params.MPYL_TEST == null || params.MPYL_TEST == ""  } }
            steps {
                script {
                    properties([parameters([
                        ...
                        string(name: 'MPYL_TEST', defaultValue: 'wajo', description: 'MPyL version to be installed')
                    ])])
                ...
                script {
                    ...
                    withKubeConfig([credentialsId: 'jenkins-rancher-service-account-kubeconfig-test']) {
                        wrap([$class: 'BuildUser']) {
                             echo "params is ${params.MPYL_TEST}"
